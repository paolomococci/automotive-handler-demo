...
class AddressRepositoryMockMvcTests {
    ...
    val item: String = """{"country":"Thailand","region":"north","city":"Chiang Mai","zip":"50000","avenue":"Chang Road","civic":"123","internal":"A"}"""
    ...
    @Test @Throws(Exception::class) fun `retrieve test`() {
        ...
        mockMvc?.perform(MockMvcRequestBuilders.get(result!!))
                ...
                ?.andExpect(MockMvcResultMatchers.jsonPath("$.zip").value("50000"))
